...
type Interface interface {
	...
	EvencontrollerV1alpha1() evencontrollerv1alpha1.EvencontrollerV1alpha1Interface
...
type Clientset struct {
	*discovery.DiscoveryClient
	evencontrollerV1alpha1   *evencontrollerv1alpha1.EvencontrollerV1alpha1Client
...
func (c *Clientset) EvencontrollerV1alpha1() evencontrollerv1alpha1.EvencontrollerV1alpha1Interface {
	return c.evencontrollerV1alpha1
}
...
func NewForConfigAndClient(c *rest.Config, httpClient *http.Client) (*Clientset, error) {
	...
	var cs Clientset
	var err error
	cs.evencontrollerV1alpha1, err = evencontrollerv1alpha1.NewForConfigAndClient(&configShallowCopy, httpClient)
	if err != nil {
		return nil, err
	}
...
func New(c rest.Interface) *Clientset {
	var cs Clientset
	cs.evencontrollerV1alpha1 = evencontrollerv1alpha1.New(c)
