...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	switch resource {
	// Group=evencontroller.k8s.io, Version=v1alpha1
	case v1alpha1.SchemeGroupVersion.WithResource("evens"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Evencontroller().V1alpha1().Evens().Informer()}, nil
